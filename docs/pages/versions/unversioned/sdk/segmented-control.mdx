...
> **info** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/segmentedcontrol) for `@react-native-segmented-control/segmented-control`, powered by SwiftUI on iOS and Jetpack Compose on Android.
