...
> **info** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/datetimepicker) for `@react-native-community/datetimepicker`, powered by SwiftUI on iOS and Jetpack Compose on Android.
