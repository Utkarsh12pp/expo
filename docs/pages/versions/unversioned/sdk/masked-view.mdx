...
> **info** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/maskedview) for `@react-native-masked-view/masked-view`, powered by SwiftUI on iOS and Jetpack Compose on Android.
