...
> **info** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/slider) for `@react-native-community/slider`, powered by SwiftUI on iOS and Jetpack Compose on Android.
