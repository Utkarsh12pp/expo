...
> **info** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/picker) for `@react-native-picker/picker`, powered by SwiftUI on iOS and Jetpack Compose on Android.
